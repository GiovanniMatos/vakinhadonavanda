    ...
    return(
        ...
        <div className="ml-4 lg:flex justify-between">
            <div className="mb-4 lg:ml-32">
                ...
                <p className="text-left flex">Seja um dos contribuidores desta vaquinha <FaHeart className="ml-1 mt-1" color="red"/></p>
                <div className="flex">
                    ...
                    <div className="text-left text-xs">
                        ...
                        <p>Manaus AM</p>
                        <p>Ativo(a) no Vaquinha desde outubro/2024</p>
                    </div>
                </div>
            </div>
        </div>
